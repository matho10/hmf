...
class optim:
    def __init__(self, problem="max", state: dict = {},
        ...
        first works to define discrete spaces, then can be used to compute and optimize functions
        on these discretized spaces, computing the constrained problem, and computing transition matrix
    ...
    def populate_Q(self):
        '''
        populate_Q() works to generate self.Q, which is a L x S sparse matrix,
